var AppletJS = {
	...
	loadApplet: function(attributes = null, parameters = null, minimumJavaVersion = null, fallbackContent = null, callbackFunction = null) {
		if (attributes != null) {
	...
	constructObject: function(msieQuirks = false) {
		var html = '\n<object';
